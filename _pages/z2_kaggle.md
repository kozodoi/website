...
- &#129352; **PetFinder Pawpularity Contest**, *top-4%*. Predicted pet popularity from image and tabular data <button class="btn" style="padding-top: 4px; padding-bottom: 4px; padding-left: 10px; padding-right: 10px;" onclick="window.open('https://github.com/kozodoi/Pet_Pawpularity')" type="button">&#128187; GitHub</button> <button class="btn" style="padding-top: 4px; padding-bottom: 4px; padding-left: 10px; padding-right: 10px;" onclick="window.open('https://share.streamlit.io/kozodoi/pet_pawpularity/main/web_app.py')" type="button">&#128202; App</button>
