To date, a number of algorithmic group fairness metrics have been
...
Proportional parity is very similar to Demographic parity. Proportional
...
In the upper row, the raw precision values are shown for all
